...
<body class="bg-[#f4f7f6] font-sans flex text-gray-800 h-screen overflow-hidden">
    ...
    <aside class="w-72 bg-[#10b981] text-white flex flex-col shadow-xl z-50 shrink-0 h-full">
        ...
        <nav class="mt-4 flex-grow pl-6 overflow-y-auto pr-2 space-y-1 pb-10">
            ...
            <a href="#" onclick="showView('tahun-ajaran')" id="nav-tahun-ajaran"
    ...
    <main class="flex-1 p-6 md:p-10 overflow-y-auto h-full relative w-full">
        ...
        <div id="view-tahun-ajaran" class="view-section active">
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">

                <div
                    class="xl:col-span-1 bg-white p-8 rounded-[30px] shadow-sm border border-gray-50 h-fit sticky top-10">
                    <h3
                ...
                <div class="xl:col-span-2 bg-white p-8 rounded-[30px] shadow-sm border border-gray-50">
                    ...
                    <div class="mt-6 bg-blue-50/50 border border-blue-100 p-4 rounded-xl flex items-start gap-3">
                        ...
                        <p class="text-[10px] text-gray-500 leading-relaxed font-medium">
                            ...
                            Ajaran Aktif akan digunakan sebagai standar rekaman status Siswa dan riwayat Poin
                            Kedisiplinan
                            secara *real-time*.
                        </p>
                    </div>
    ...
    <script>
        // Logika Untuk Pindah Tab (Tahun Ajaran <--> Profil)
        function showView(viewId) {
            ...
            if (viewId === 'tahun-ajaran') {
                if (titleEl) titleEl.innerText = "Manajemen Tahun Ajaran";
                document.getElementById('nav-tahun-ajaran')?.classList.add('active');
            }
        }
        document.addEventListener('DOMContentLoaded', function() {
            // Logika Animasi Dropdown
