...
<body class="bg-[#f4f7f6] font-sans flex text-gray-800">
    ...
    <main class="flex-1 md:ml-72 p-6 md:p-10 relative w-full overflow-x-hidden transition-all duration-300">
            ...
            <div class="relative">
                <button id="profileDropdownBtn"
                    ...
                    <img src="{{ $user['photo'] ?? 'https://ui-avatars.com/api/?name=' . urlencode($user['name'] ?? 'Admin') . '&background=10b981&color=fff' }}"
                        class="w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-green-50 shadow-sm" alt="Profile">
        ...
        <div id="view-profile" class="view-section">
            <div class="bg-white p-6 md:p-8 rounded-[30px] shadow-sm border border-gray-50 max-w-2xl mx-auto">
                <!-- Profile Display -->
                <div id="profileView" class="flex flex-col items-center">
                    ...
                    <h3 class="text-2xl font-black text-gray-800 uppercase text-center">
                        {{ $user['name'] ?? 'Nama Pengguna' }}</h3>
                    ...
                    <div class="w-full space-y-4">
                        <div class="flex items-center p-4 md:p-5 bg-gray-50 rounded-2xl border border-gray-100">
                            <i class="fas fa-envelope text-[#10b981] w-8 md:w-10 text-center text-xl"></i>
                        ...
                        <div class="flex items-center p-4 md:p-5 bg-gray-50 rounded-2xl border border-gray-100">
                            <i class="fas fa-venus-mars text-[#10b981] w-8 md:w-10 text-center text-xl"></i>
                            <div class="ml-4">
                        ...
                        <div class="flex items-center p-4 md:p-5 bg-gray-50 rounded-2xl border border-gray-100">
                            <i class="fas fa-phone-alt text-[#10b981] w-8 md:w-10 text-center text-xl"></i>
                            <div class="ml-4">
                ...
                <form id="profileForm" class="hidden flex flex-col" action="{{ route('profile.update') }}"
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mt-8">
                        <button type="submit"
                            class="w-full sm:flex-1 bg-[#10b981] text-white px-6 py-4 rounded-xl text-xs font-bold uppercase tracking-wider shadow-lg shadow-green-100 hover:bg-green-600 transition">Simpan</button>
                        <button type="button" onclick="toggleEditProfile(false)"
                            class="w-full sm:flex-1 bg-gray-100 text-gray-600 px-6 py-4 rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-gray-200 transition">Batal</button>
                    </div>
                </form>
            </div>
        </div>
