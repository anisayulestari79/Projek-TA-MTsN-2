        ...
        function openDetailSiswaModal(btn) {
            ...
            if ((status || '').toLowerCase() === 'aktif') {
                statusBadge.className =
                    'text-[10px] md:text-xs font-bold text-green-700 bg-green-100 px-3 py-1 rounded-full uppercase border border-green-200';
            } else if ((status || '').toLowerCase() === 'lulus') {
                statusBadge.className =
                    'text-[10px] md:text-xs font-bold text-blue-700 bg-blue-100 px-3 py-1 rounded-full uppercase border border-blue-200';
            } else {
                statusBadge.className =
                    'text-[10px] md:text-xs font-bold text-red-700 bg-red-100 px-3 py-1 rounded-full uppercase border border-red-200';
            }
