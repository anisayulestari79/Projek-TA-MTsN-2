...
<body class="bg-[#f4f7f6] font-sans flex text-gray-800">
    ...
    <!-- SIDEBAR (Desain disamakan dengan Admin) -->
    <aside class="w-72 min-h-screen bg-[#10b981] text-white flex flex-col fixed shadow-xl z-50">
        ...
        <nav class="mt-4 flex-grow pl-6">
            <a href="{{ route('kamad.kamad-dashboard') }}" onclick="showView('dashboard')" id="nav-dashboard"
                ...
                <div class="bg-white p-8 rounded-[30px] shadow-sm border border-gray-50">
                    ...
                    <div class="space-y-4">
                        <div
                            ...
                            <span class="text-[10px] font-bold text-blue-700 uppercase">Total Pelanggaran</span>
                            <span
                                class="text-lg font-black text-blue-700">{{ number_format($totalPelanggaran ?? 0) }}</span>
                        </div>
                        <div
                            class="p-4 bg-yellow-50 rounded-2xl border border-yellow-100 flex justify-between items-center">
                            <span class="text-[10px] font-bold text-yellow-700 uppercase">Siswa Waspada (50+
                                Poin)</span>
                            <span class="text-lg font-black text-yellow-700">{{ number_format($waspada ?? 0) }}</span>
                        </div>
                        <div class="p-4 bg-red-50 rounded-2xl border border-red-100 flex justify-between items-center">
                            <span class="text-[10px] font-bold text-red-700 uppercase">Tindakan DO (100 Poin)</span>
                            <span class="text-lg font-black text-red-700">{{ number_format($dropOut ?? 0) }}</span>
                        </div>
                    </div>
                </div>
            </div>
